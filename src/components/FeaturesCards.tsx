  ...
  const projects = [
    {
      ...
      gallery: ['/assets/img/portfolio/hellosolar-snap-p2.jpg', '/assets/img/portfolio/solar-page2.png']
    },
    {
      ...
      image: '/assets/img/portfolio/mikiyas4.png',
      label: 'Website',
      type: 'Web',
      details:
      ...
      gallery: ['/assets/img/portfolio/mikiyas6.png', '/assets/img/portfolio/mikiyas5.png']
    },
    {
      id: 'project-tlc',
      ...
      image: '/assets/img/portfolio/tlc-final.jpg',
      ...
      gallery: ['/assets/img/portfolio/tlc-pages2.png', '/assets/img/portfolio/tlc-snap2.jpg']
    },
    {
      ...
      image: '/assets/img/portfolio/kelib2.png',
      ...
      link: '#contact',
      gallery: ['/assets/img/portfolio/6.png', '/assets/img/portfolio/3.png']
    },
    {
      ...
      image: '/assets/img/portfolio/concept-shirt.png',
      ...
      link: '#works',
      gallery: ['/assets/img/portfolio/Eritre-both.png', '/assets/img/portfolio/Eri-2.png']
    },
    {
      id: 'project-pillar-x',
      ...
      image: '/assets/img/portfolio/killme.png',
      label: 'Branding & Logo',
      type: 'Design',
      details:
      ...
      link: '#works',
      gallery: ['/assets/img/portfolio/colordone.png', '/assets/img/portfolio/pilarpic.png']
    } 
  ]
